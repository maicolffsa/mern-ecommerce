...
export const Shipping = (props) => {
  ...
  return (
    <ShippingWrapper>
      <div className="shipping-header">Dirección de envío</div>
      <div className="shipping-container">
        <div className="shipping-left">
          <form onSubmit={submitHandler} className="shipping-form">
            <div className="shipping-text">Información del contacto</div>
            <input
              ...
              required
            />
            <div className="shipping-text">Información de envío</div>
            <input
