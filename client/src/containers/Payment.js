...
export const Payment = (props) => {
  ...
  return (
    <PaymentWrapper>
      <div className="payment-header">Haga su pedido</div>
      <div className="payment-container">
        <div className="payment-left">
          <div className="left-card">
            <div className="card-header">Dirección de envío</div>
          ...
          <div className="left-card">
            <div className="card-header">Método de pago</div>
          ...
          <div className="left-card">
            <div className="card-header">Revise su orden</div>
        ...
        <div className="payment-right">
          <div className="summary">Resumen del pedido</div>
          <div className="order-line">
            <span>
              Items (
              {cartItems.reduce((a, b) => parseInt(a) + parseInt(b.qty), 0)})
            </span>
            <span>S/ {itemsPrice}</span>
          </div>
          <div className="order-line">
            <span>Envío</span>
            <span>S/ {shippingPrice}</span>
          </div>
