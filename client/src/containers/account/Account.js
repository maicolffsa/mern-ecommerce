...
export const Account = (props) => {
  ...
  const updateNameHandler = (e) => {
    ...
    if (!oldPassword && !newPassword && !newPassword2) {
      ...
      alert("Su nueva contraseña reingresada es diferente.");
    } else {
      dispatch(
        update({
          userId: userInfo._id,
  ...
  return (
    <AccountWrapper>
      <div className="account-header">Mi cuenta</div>
      <form className="account-form" onSubmit={updateNameHandler}>
        ...
        <div className="password">
          <div className="password-header">Contraseña</div>
          <div className="fill-box">
          ...
          <div className="fill-box">
            <label htmlFor="newPassword2">Repita su contraseña nueva</label>
            <input
              value={newPassword2}
              name="newPassword2"
              id="newPassword2"
        ...
        {loading ? (
          <div className="tip">Guardando...</div>
        ) : error ? (
          <div className="tip">{error.msg}</div>
        ) : success ? (
          <div className="tip">Cuenta Actualizada.</div>
        ) : null}
