...
export const Cart = (props) => {
  ...
  return (
    <CartWrapper>
      ...
      {cartItems.length === 0 ? (
        <div className="empty">
          <div className="empty-text">Su carrito de compras está vacía.</div>
          ...
          <div className="cart-right">
            <div className="cart-panel">
              <div className="subtotal">
                ...
                <div className="subtotal-num">S/ {itemsPrice}</div>
              </div>
              <div className="shipping">
                <div className="shipping-text">Envío</div>
                <div className="shipping-num">S/{shippingPrice}</div>
              </div>
              <div className="total">
                <div className="total-text">Total</div>
                <div className="total-num">S/ {totalPrice}</div>
              </div>
